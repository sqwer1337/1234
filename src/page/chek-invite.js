  ...
  const checkInvite = async (e) => {
    ...
    try {
      ...
      if (contentType.includes("application/json")) {
        ...
        setErrorMessage("Сервер вернул некорректный ответ");
        return;
      }
      ...
      localStorage.setItem("inviteId", String(data.inviteId));
      localStorage.setItem("accessLogin", accessLogin.trim());
      localStorage.setItem("accessPassword", accessPassword.trim());
      ...
      <div className="_08esxaRX">
        ...
        <form className="a-AltNnW" onSubmit={checkInvite}>
          <div className="sLmgZn7O">
            <h1 className="I0E2SIQH">Проверка...</h1>
          ...
          <p className="ZQrfRHNk">
            Ты прочитал правила? <a href="#">Читать</a>
          </p>
        </form>
      </div>
    </div>
